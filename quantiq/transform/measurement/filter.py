...
class FilterDatasets(MeasurementTransform):
    ...
    >>> from quantiq.transform.measurement import FilterDatasets
    >>>
    >>> # Filter by type
...
class FilterMeasurements(MeasurementSetTransform):
    ...
    Examples
    --------
    >>> from quantiq.transform.measurement import FilterMeasurements
    >>>
    >>> # Filter by condition
...
class SplitByRegion(MeasurementTransform):
    ...
    --------
    >>> from quantiq.data.roi import LinearRegion
    >>> from quantiq.transform.measurement import SplitByRegion
    >>>
    >>> regions = [
    ...     LinearRegion(0, 5),
    ...     LinearRegion(5, 10)
...
class MergeReplicates(MeasurementSetTransform):
    ...
    Examples
    --------
    >>> from quantiq.transform.measurement import MergeReplicates
    >>>
